...
def main(args):
    ...
    texto_pdf = f'''# Sumário Executivo
## Avaliação da Disciplina de {args.c} ({args.y})\n\n
### Objetivo
Este relatório resume os principais pontos positivos e negativos identificados nas
respostas dos alunos à disciplina de {args.c}, com base numa análise de conteúdo textual.
### Pontos positivos
{str(data['positive'])}
### Pontos a melhorar
{str(data['negative'])}
...
if __name__ == '__main__':
    ...
    parser.add_argument('-u', type=str, default='http://127.0.0.1:8000/report', help='service url')
